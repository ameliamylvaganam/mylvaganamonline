...
let about = [
  {
    ...
    blurb: "Amelia Mylvaganam is a filmmaker, etc. trying to find the hidden worlds in the cracks and glimmers of this one. She is currently based in Washington, DC.",
    contact:
