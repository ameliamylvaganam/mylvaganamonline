...
let about = [
  {
    ...
    contact:
      `<br><br>{this site is a selection of some things I've made or worked on-- please contact me if looking for info about a project that is not listed}<br>most films are watchable on <a href='https://amathus.vhx.tv/' target='_blank'>amathus</a>. alternatively, feel free to contact me for screening links.
